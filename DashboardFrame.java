...
public class DashboardFrame extends JPanel {
    ...
    public DashboardFrame(Wallet wallet) {
    ...
    private JPanel buildMainDashboardView() {
        ...
        JLabel cashTitle = new JLabel("Total Cashback Earned");
        cashTitle.setForeground(Color.GRAY);
        cashbackLabel = new JLabel("₹ " + String.format("%.2f", currentWallet.getTotalCashback()));
    ...
    private void updateDashboardMetrics() {
        ...
        cashbackLabel.setText("₹ " + String.format("%.2f", currentWallet.getTotalCashback()));
        populateHistoryLogs();
    }
